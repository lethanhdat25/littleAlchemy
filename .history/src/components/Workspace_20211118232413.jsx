...
const Workspace = () => {
  ...
  const mergeElement=(yourRecipe,position,yourIndex)=>{
    ...
    console.log(elementFonded);
 
     const newElement = elementDropped.map((element, index)=>{
        if(index===yourIndex){
          return Object.assign(element,{position})
        }
      })
