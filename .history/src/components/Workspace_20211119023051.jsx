...
const Workspace = () => {
  ...
  const mergeElement=(yourRecipe,yourPosition,yourIndex)=>{
    const elementFonded=recipes.find(element=>(element[1].name1===yourRecipe[0]&&element[1].name2===yourRecipe[1])||(element[1].name1===yourRecipe[1]&&element[1].name2===yourRecipe[0])&&element)
