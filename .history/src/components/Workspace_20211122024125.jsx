...
const Workspace = (props) => {
  ...
  const addElement=(item,position)=>{
    ...
    setElementDropped((state) =>{
        ...
        if(elementFind){
          const copElement=[].push({...elementFind,position});
          console.log(copElement);
          console.log("chayj");
          console.log(state.slice(state[elementIndex],1,copElement));
          return state.slice(state[elementIndex],1,copElement);
