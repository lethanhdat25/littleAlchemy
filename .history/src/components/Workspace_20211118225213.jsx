...
const Workspace = () => {
  ...
  useEffect(()=>{
    elementDropped.forEach((element,index)=>{
      if(Math.abs(element.position.x-elementDropped[elementDropped.length-1].position.x)<=85&&Math.abs(element.position.y-elementDropped[elementDropped.length-1].position.y)<=85){
