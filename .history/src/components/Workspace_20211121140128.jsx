...
const Workspace = (props) => {
  ...
  const [{item,position }, drop] = useDrop(() => ({
    ...
    drop: (item, monitor) => {
      ...
      const idOfElement=item.name+"-"+indexElement;
      setDropped(state=>state.concat({...item, position,id:idOfElement,inSpace:true}));
      setElementDropped((state) =>state.concat({ ...item, position,id:idOfElement }));
      indexElement++;
    },
