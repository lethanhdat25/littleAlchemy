...
const Workspace = () => {
  ...
  for (let i = 0; i < context.element.length - 1; i++) {
      if (
        ...
        const resultCheck=recipes.forEach(recipe=>{
          if((yourRecipes[0][0]===recipe[1][0]&&yourRecipes[0][1]===recipe[1][1])||(yourRecipes[1][0]===recipe[1][0]&&yourRecipes[1][1]===recipe[1][1])){
