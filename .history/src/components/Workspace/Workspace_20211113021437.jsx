...
import { DRAG, ITEM_TYPE } from "../../constants/index";
...
const Workspace=()=>{
    ...
    const renderElement=(coordinate,src)=>{
        setCombineElement(state=>state.concat(<Element elementRef={DRAG} src={src} style={{position: "absolute",left: coordinate.x,top: coordinate.y,}}/>));
    }
