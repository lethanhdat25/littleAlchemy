    ...
    const [,drag]=useDrag(()=>({ 
        type: "drag",
            ...
            if(monitor.getDropResult()){
                setIsDone(true);
                console.log(divElement.current["data-elementtype"]);

            };
        },
        collect:monitor=>({isDragging:monitor.isDragging()})
    }));
    useImperativeHandle(ref,()=>({getClassName:getClassName}));
    const style={position: "absolute",left: x,top: y,};
    return(
        <div ref={divElement} className={classes.element} data-elementtype="libraryBox"  style={style}>
